...
public class MyFormatterTest {
  ...
  public void test_Formater() {
    ...
    String Input =
        "{'player_0':[{'neighbor':[{'neighbor_0':'bTerr2'},{'neighbor_1':'a_neigh2'}],'territoryName':'aTerr1'},{'neighbor':[{'neighbor_0': 'a_neigh3'},{'neighbor_1': 'a_neigh4'}],'territoryName':'aTerr2'}],'player_1':[{'neighbor':[{'neighbor_0':'b_neigh1'},{'neighbor_1':'b_neigh2'}],'territoryName':'bTerr1'},{'owner':'bbb','neighbor':[{'neighbor_0':'b_neigh3'},{'neighbor_1':'b_neigh4'}],'territoryName':'bTerr2'}]}";
