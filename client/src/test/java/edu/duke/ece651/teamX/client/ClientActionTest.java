...
public class ClientActionTest {
  ...
  public void test_FindTerr() throws IOException, ClassNotFoundException {
    ...
    // Test for the move
    ClientMove move1 = new ClientMove(null, output, uir, tp1, map, new Player("Yellow", 20));
    ...
    ClientMove move3 = new ClientMove(null, output, uir, tp1, map, new Player("Blue", 20));

    // Test for the attack
    ClientAttack att1 = new ClientAttack(null, output, uir, tp1, map, new Player("Yellow", 20));
